---
name: diff-review
description: Revisa o diff atual quanto a correção e convenções do projeto, despachando o subagent code-reviewer e, para mudança visual, a skill design-review. Usar antes de finalizar ou abrir PR.
