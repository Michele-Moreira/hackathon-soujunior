...
| Navegador | google chome |
| Versão do navegador | v154.0.8037.58 |
| Sistema operacional | windos |
| Dispositivo | desktops |
| Resolução / viewport | 1366 x 768 |
| URL testada | hackathon-soujunior.vercel.app |
| Branch | qa.md |
